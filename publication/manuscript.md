...
A complete formal definition is provided in the supplementary materials. Because of the computational requirements of grid search algorithms, we limited our sequence sample size to the first 100 sequences from the test holdout set.
...
\begin{tabular}{ccc}
\hline
{\textbf{Condition}} & \textbf{Negative Class (Feature 7030)} & \textbf{Positive Class (Feature 3378)} \\
\hline
\parbox[c][3.1cm][c]{0.28\textwidth}{\centering Min Act = 15\\Amp/Suppress = Ablation} &
\includegraphics[width=0.31\textwidth]{figures/image7.png} &
\includegraphics[width=0.31\textwidth]{figures/image8.png} \\
\hline
\parbox[c][3.1cm][c]{0.28\textwidth}{\centering Min Act = 0.1\\Amp/Suppress = 10.0} &
\includegraphics[width=0.31\textwidth]{figures/image9.png} &
\includegraphics[width=0.31\textwidth]{figures/image10.png} \\
\hline
\end{tabular}
\end{center}
...
\begin{tabular}{ccc}
\hline
{\textbf{Condition}} & \textbf{Negative (Feature 7030)} & \textbf{Positive (Feature 3378)} \\
\hline
\parbox[c][3.1cm][c]{0.28\textwidth}{\centering Min Act = 15.0\\Amp/Suppress = Ablation} &
\includegraphics[width=0.31\textwidth]{figures/image11.png} &
\includegraphics[width=0.31\textwidth]{figures/image12.png} \\
\hline
\parbox[c][3.1cm][c]{0.28\textwidth}{\centering Min Act = 0.1\\Amp/Suppress = 10.0} &
\includegraphics[width=0.31\textwidth]{figures/image13.png} &
\includegraphics[width=0.31\textwidth]{figures/image14.png} \\
\hline
\end{tabular}
\end{center}
